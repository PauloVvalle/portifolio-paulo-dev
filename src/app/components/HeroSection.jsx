    ...
    <section>
      <div className="grid drig-cols-1 lg:grid-cols-12">
        <div className="col-span-7 place-self-center text-center sm:text-left">
          ...
          <div>
            <button className="px-6 py-3 w-full sm:w-fit rounded-full mr-4 bg-gradient-to-br from-blue-200 via-blue-500 to-blue-950 hover:bg-slate-800 text-white">
              Me contrate
            </button>
            <button className="px-1 py-1 w-full sm:w-fit rounded-full bg-gradient-to-br from-blue-200 via-blue-500 to-blue-950 hover:bg-slate-800 text-white mt-3">
